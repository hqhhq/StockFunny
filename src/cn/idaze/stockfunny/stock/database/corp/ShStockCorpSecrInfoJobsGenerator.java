 ...
 * @author hhq
 */
public class ShStockCorpSecrInfoJobsGenerator {

    public static void main(String[] args) {
        ShStockCorpSecrInfoJobsGenerator generator = new ShStockCorpSecrInfoJobsGenerator();
        Map<String, String> map = new HashMap<String, String>();
        map.put("DTE", "20180316");
        map.put("JOBID", "STK_SH_004");
    ...
    public boolean execJob(Map<String, String> params) {
        ...
        Logger logger = Logger.getLogger(ShStockCorpSecrInfoJobsGenerator.class);

        String dateStr;
        //作业"生成上交所公司董秘信息获取作业"的作业代码,后续将作业新生成作业的父作业
        String jobId;
        ...
        try {
            ...
            if (rs.getInt(1) > 0) {
                logger.error("已存在 生成上交所公司董秘信息获取作业 ，执行失败");
                return false;
            }

        } catch (SQLException sqlex) {
            logger.error("SQL执行失败！无法查询 生成上交所公司董秘信息 ！" + sqlex.getMessage());
            return false;
        }
        ...
        try {
            ...
            ps.setString(3, "上交所公司董秘信息获取");
            ps.setString(4, "cn.idaze.stockfunny.stock.database.corp.ShStockCorpSecrInfoImporter");
            ...
            logger.error("插入作业SQL执行失败！生成上交所公司董秘信息获取作业失败！" + sqlex.getMessage());
            return false;
        }

        logger.debug("生成上交所公司董秘信息获取作业 成功！");
        return true;
    }
}
